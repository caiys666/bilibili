...
<div>
    ...
    <login-text style="margin-top: 2vw" label="姓名" placeholder="请输入姓名" rule="^.{6,16}$" @inputChange="(res) => (model.name = res)"></login-text>
    <login-text label="账户" placeholder="请输入账户" rule="^.{6,16}$" @inputChange="(res) => (model.username = res)"></login-text>
